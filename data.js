...
const allCoffeeShops = [
  {
    ...
    rating: 4.3, // [cite: 16]
    image: "assets/shops/lava_coffee.png", // Bạn cần thêm ảnh này vào folder assets/shops
  ...
  },
  {
    ...
    rating: 4.3, // [cite: 40]
    image: "assets/shops/dumien_garden.png", // Bạn cần thêm ảnh này vào folder assets/shops
  ...
  },
  {
    ...
    rating: 4.4, // [cite: 64]
    image: "assets/shops/saigon_chic.png", // Bạn cần thêm ảnh này vào folder assets/shops
  ...
  },
  {
    ...
    rating: 4.1, // [cite: 92]
    image: "assets/shops/thuc_coffee.png", // Bạn cần thêm ảnh này vào folder assets/shops
  ...
  },
  {
    ...
    rating: 4.8, // [cite: 117]
    image: "assets/shops/oasis_cafe.png", // Bạn cần thêm ảnh này vào folder assets/shops
  ...
  },
  {
    ...
    rating: 4.4, // [cite: 140]
    image: "assets/shops/ngay_xua_ay.png", // Bạn cần thêm ảnh này vào folder assets/shops
  ...
  },
  {
    ...
    rating: 4.1, // [cite: 164]
    image: "assets/shops/country_house.png", // Bạn cần thêm ảnh này vào folder assets/shops
